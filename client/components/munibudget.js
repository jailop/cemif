import '../node_modules/vega/build/vega.js';
import '../node_modules/vega-lite/build/vega-lite.js';
import '../node_modules/vega-embed/build/vega-embed.js';
import '../node_modules/arquero/dist/arquero.js';
...
class MuniBudgetHeader extends HTMLElement {
    ...
    async preprocessData() {
        let urlData = '/data/mun-budget-year-header.csv';
...
class MuniContabHeader extends HTMLElement {
    ...
    async preprocessData() {
        let urlData = '/data/mun-contab-year-header.csv';
        this.csv = await aq.loadCSV(urlData);
    }
...
class MuniIndicator extends HTMLElement {
    ...
    async preprocessData() {
        this.dict = {};
        await fetch('/data/muni-indicators-keys.csv')
    ...
    plot() {
        ...
        let spec = {
            "mark": {"type": "line", "point": true, "tooltip": true},
            "data": {"url": "/data/muni-indicators.csv"},
            "width": "container",
